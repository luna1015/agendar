    ...
    if (response.ok) {
	  ...
	  if ( respuesta.length > 0 ) {
		  for (item of respuesta) {
			  form.elements['nombre'].value = item.nombre_usuario;
			  form.elements['apellidos'].value = item.apellidos_usuario;
			  form.elements['usuario'].value = item.user_usuario;
			  form.elements['contrasena'].value = item.password_usuario;
			  form.elements['nombre_rol'].value = item.nombre_rol;
			  form.elements['activo'].value = item.activo_usuario;
		  } // End for
