...
<html>
<head>    
    <title>Nueva Esteticistas</title>
...
<body>
    ...
    <label class="tituloGeneral">Nueva Esteticista</label>
   <form action="../../back/esteticista/registrar.php" method="post" class="estiloFormulario">
