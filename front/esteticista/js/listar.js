...
async function cargarFormulario(idElement) {
  ...
  var datos = { 
				id_esteticista: idElement,
				eliminado_esteticista: 1
			};
    ...
    if (response.ok) {
	  ...
	  if ( respuesta.length > 0 ) {
		  for (item of respuesta) {
			  ...
			  filas += "<td>"+item.numero_documento_esteticista+"</td>";
			  filas += "<td>"+item.nombre_esteticista+"</td>";
			  filas += "<td>"+item.apellidos_esteticista+"</td>";
			  filas += "<td align='center'>";
			  filas += "<a href='detalleEsteticista.php?id="+item.id_esteticista+"'><img src='../imagen/detalle.png'></a>";
			  filas += "<a href='editarEsteticista.php?id="+item.id_esteticista+"'><img src='../imagen/editar.png'></a>";
			  filas += "<a href='' onclick='return eliminarRegistro("+item.id_esteticista+")'>";
