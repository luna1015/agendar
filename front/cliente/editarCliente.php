...
<body>
    ...
    <label class="tituloGeneral">Editar Cliente</label>
   <form action="../../back/cliente/actualizar.php" method="post" class="estiloFormulario">
    <fieldset id="estiloFieldset">
		...
		<div class="botonFormulario">
			...
			<a href="listarClientes.php"><input type="button" value="Cancelar"></a>
		</div>
