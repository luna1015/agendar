    ...
    if (response.ok) {
	  ...
	  if ( respuesta.length > 0 ) {
		  for (item of respuesta) {
			  ...
			  filas += "<td>"+item.numero_documento_cliente+"</td>";
			  filas += "<td>"+item.nombre_cliente+"</td>";
			  filas += "<td>"+item.apellidos_cliente+"</td>";
			  filas += "<td align='center'>";
			  filas += "<a href='detalleCliente.php?id="+item.id_cliente+"'><img src='../imagen/detalle.png'></a>";
			  filas += "<a href='editarCliente.php?id="+item.id_cliente+"'><img src='../imagen/editar.png'></a>";
			  filas += "<a href='' onclick='return eliminarRegistro("+item.id_cliente+")'>";
