...
<body>
    ...
    <label class="tituloGeneral">Editar Servicio</label>

        <form action="../../back/servicio/actualizar.php" method="post" class="estiloFormulario">
            <fieldset id="estiloFieldset">
                ...
                <div class="elementoFormulario">
                    ...
                    <input type="number" id="tarifa" name="tarifa" value="" required>
                </div>
                <div class="elementoFormulario">
                ...
                <div class="botonFormulario">
                    ...
                    <a href="listarServicios.php"><input type="button" value="Cancelar"></a>
				</div>
