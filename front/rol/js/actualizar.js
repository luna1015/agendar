    ...
    if (response.ok) {
	  ...
	  if ( respuesta.length > 0 ) {
		  for (item of respuesta) {
			  form.elements['nombre'].value = item.nombre_rol;
			  form.elements['descripcion'].value = item.descripcion_rol;
			  form.elements['activo'].value = item.activo_rol;
		  } // End for
