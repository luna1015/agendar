    ...
    if (response.ok) {
	  ...
	  if ( respuesta.length > 0 ) {
		  for (item of respuesta) {
			  ...
			  filas += "<td>"+item.nombre_rol+"</td>";
			  filas += "<td>"+item.descripcion_rol+"</td>";
			  filas += "<td align='center'>";
			  filas += "<a href='detalleRol.php?id="+item.id_rol+"'><img src='../imagen/detalle.png'></a>";
			  filas += "<a href='editarRol.php?id="+item.id_rol+"'><img src='../imagen/editar.png'></a>";
			  filas += "<a href='' onclick='return eliminarRegistro("+item.id_rol+")'>";
...
async function enviarFormulario(ev) {
  ...
  //var datos = new FormData(form);
  var datos = { 
				nombre_rol: form.elements['nombre'].value,
				descripcion_rol: form.elements['descripcion'].value,
				activo_rol: form.elements['activo'].value,
				eliminado_rol: 0
