...
<html>
<head>    
    <title>Detalle Esteticista</title>
...
<body>
    ...
    <label class="tituloGeneral">Detalle Esteticista</label>
   <form action="../../back/esteticista/listar.php" method="post" class="estiloFormulario">
    <fieldset id="estiloFieldset">
        <legend>Información General</legend>
            ...
            <div class="botonFormulario">
                <a href="listarEsteticistas.php"><input type="button" value="Volver"></a>
            </div>
